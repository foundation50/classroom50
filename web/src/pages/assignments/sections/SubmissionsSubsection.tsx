...
// The submission definition: branch (every default-branch student commit
// counts) vs tag (on submit only). Always visible. The retrofit edit warning
// only shows when a built-in shim exists (there is a shim to update).
